...
class Args(object):
    def __init__(self) -> None:
        super().__init__()
        self.name = "NAME"
        self.model = "Flow2Flow"
        self.crop_shape = (128, 128)
        self.resize_shape = (144, 144)
        self.data_dir ="data/testdata"
        self.gpu_ids =[0,1,2,3]
        self.batch_size =1#16
        self.iters_per_print= 16 
        self.iters_per_visual =320 
        self.norm_type= "instance" 
        self.num_blocks= 0#4 
        self.num_channels_g = 1#32 
        self.num_epochs =200 
        self.num_scales= 2 
