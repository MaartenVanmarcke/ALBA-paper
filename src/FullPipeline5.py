...
if __name__=="__main__":
    ...
    query_budget = 5"""
    methods = [ ActiveLearning(),RandomSampling()]#AlbaMethod(),SmartInitialGuessMethod(), ,SmartInitialGuessMethod(),WithoutAlignmentMethod(),ActiveLearning(),RandomSampling()]#,WithAlignmentMethod() SmartInitialGuessMethod(), AlbaMethod(), ActiveLearning(), RandomSampling()]
