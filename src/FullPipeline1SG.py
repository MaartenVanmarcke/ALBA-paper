...
if __name__=="__main__":
    inputDatas = [id.Speech_36_copy()]#[TestData()]
    nclusters = 50
    instance_per_bag = 50
    nbags = 10
    bag_contfactor = .3
    ...
    query_budget = 5"""
    methods = [SmartInitialGuessMethod()]#,SmartInitialGuessMethod(),WithoutAlignmentMethod(),ActiveLearning(),RandomSampling()]#,WithAlignmentMethod() SmartInitialGuessMethod(), AlbaMethod(), ActiveLearning(), RandomSampling()]
