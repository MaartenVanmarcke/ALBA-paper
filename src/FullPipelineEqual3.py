...
from pipeline.constructBags import ConstructBagsWithoutClustering
...
if __name__=="__main__":
    inputDatas = [id.Cardiotocography_7()]#[TestData()]
    nclusters = 50
    instance_per_bag = 50
    nbags = 10
    bag_contfactor = .3
    constructBags = ConstructBagsWithoutClustering(nclusters,nbags, instance_per_bag,bag_contfactor)
    preprocessor = Preprocessor()
    checker = Checker()
    saver = Saver()
